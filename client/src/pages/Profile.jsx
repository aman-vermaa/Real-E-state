    ...
    <div className="p-3 max-w-lg mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-1">
        ...
        <img
          ...
          alt="profile"
          className="rounded-lg h-24 w-24 object-cover cursor-pointer self-center m-2"
        />
        '
      ...
      {userListings && userListings.length > 0 && (
        <div ref={listingsRef} className="flex flex-col gap-4">
          ...
          {userListings.map((listing) => (
            <div
              key={listing._id}
              className=" border rounded-lg p-3 flex justify-between items-center hover:scale-110 transition-transform duration-300 gap-4"
            >
